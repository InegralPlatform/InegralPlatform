				...
				<div class="row">
					<div class="col-md-4 col-sm-12 col-xs-12  center-block ">
						<div class="icon one ">
							...
							<h4 class="service-11"><big></big><br />ERP</h4>
...
Customer Relationship System
					...
					<div class="col-md-4   col-sm-12 col-xs-12  center-block">
						...
						<img src="images/services/service/responsive.svg" alt="bacteria.png" class="img-responsive center-block wow  bounceIn">
							<h4><big></big><br />Web Developing</h4>
				...
				<div class="row">
					<div class="col-md-4  col-sm-12 col-xs-12 center-block ">
						<div class="icon four">
							...
							<h4 class="service-11"><big></big><br />Motion graphics</h4>
					...
					<div class="col-md-4   col-sm-12 col-xs-12  center-block">
						<div class="icon six">
							...
							<h4 class="service-11"><big></big><br />E-Commerce Web Development</h4>
					...
					<div class="col-md-4   col-sm-12 col-xs-12  center-block">
						<div class="icon six">
							...
							<h4 class="service-11"><big></big><br />Digital Markting</h4>
							<!-- <p>Online shopping is getting popular nowadays and it is a major necessity for Business to set up a good e-commerce site.we  offer successful solutions for developing e-commerce and shopping cart websites for online business and we have the expertise team to develop the e-commerce websites to promote your business.</p> -->
							<p>
							 <ul>
								 <li>
