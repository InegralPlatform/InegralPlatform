			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-4 col-sm-12 col-xs-12  center-block ">
						<div class="icon one ">
							<!-- <img src="../images/xcode.png" alt="bacteria.png" class="img-responsive center-block wow  bounceIn"> -->
							<h4 class="service-11"><big>1</big><br />iPhone Application Development</h4>
					...
					<div class="col-md-4  col-sm-12 col-xs-12 center-block">
						<div class="icon two">
							<!-- <img src="../images/android.png" alt="bacteria.png" class="img-responsive center-block wow  bounceIn"> -->
							<h4><big>2</big><br />Android Application Development</h4>
					...
					<div class="col-md-4   col-sm-12 col-xs-12  center-block">
						<div class="icon three">
							...
							<h4><big>3</big><br />Internet of Things (IoT)</h4>
				...
				<div class="row">
					<div class="col-md-4  col-sm-12 col-xs-12 center-block ">
						<div class="icon four">
							...
							<h4 class="service-11"><big>4</big><br />Big Data</h4>
					...
					<div class="col-md-4   col-sm-12 col-xs-12 center-block ">
						<div class="icon five">
							...
							<h4 class="service-11"><big>5</big><br />Cross Platform App Development</h4>
