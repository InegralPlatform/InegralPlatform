				...
				<div class="row">
					<div class="col-md-4 col-sm-12 col-xs-12  center-block ">
						<div class="icon one ">
							...
							<h4 class="service-11"><big>1</big><br />ERP</h4>
					...
					<div class="col-md-4  col-sm-12 col-xs-12 center-block">
						<div class="icon two">
							...
							<h4><big>2</big><br /> Application Development</h4>
					...
					<div class="col-md-4   col-sm-12 col-xs-12  center-block">
						<div class="icon three">
							...
							<h4><big>3</big><br />Web Developing</h4>
				...
				<div class="row">
					<div class="col-md-4  col-sm-12 col-xs-12 center-block ">
						<div class="icon four">
							...
							<h4 class="service-11"><big>4</big><br />Motion graphics</h4>
