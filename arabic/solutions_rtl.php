<div class="all">
			<div class="container">
				<h1 class="wow  bounceIn">الحلول</h1>
				<hr class="center-block">
				<div class="row">
					<div class="col-md-4 col-sm-12 col-xs-12  center-block ">
						<a href="services\solutions\solution1\arabicConvertYourPhpWebsiteIntoAnApp"><div class="icon one ">
							<!--  <img src="images/xcode.png" alt="png" class="img-responsive center-block wow  bounceIn">-->
							<h4 class="service-11">تحويل موقعك الالكترونى الى تطبيق للهواتف الذكية</h4>
							<p>
								ندرك أنك تلبي بالفعل احتياجات العملاء والعملاء المحتملين من خلال موقع الويب الحالي الخاص بك ، ولكننا نعلم أيضًا أنك لن تغتنم فرصة لزيادة ظهورك وحضورك.
							</p>
						</div><a href="#"></a>
					</div>
					<div class="col-md-4  col-sm-12 col-xs-12 center-block">
					<a href="#">
					  <div class="icon two">
							...
							<p>
 يساعد فريقنا من مطوري برامج Android الذين يتمتعون بإبداعهم ومهاراتهم وخبراتهم ومبادراتهم في إنشاء تطبيق رائع فحسب ، بل يساعدون على تخصيصه وفقًا لجمهورهم المستهدف والمساعدة في تنمية نشاطهم التجاري. بفضل فريقنا ، سيتم تحسين تطبيقك للحصول على المظهر والسرعة والأداء على جميع أجهزة Android.</p>
						</div></a>
					</div>
					<div class="col-md-4   col-sm-12 col-xs-12  center-block">
						<a href="services\solutions\solution2\arabicMobileAppsForSchools"><div class="icon three">
							<!-- <img src="images/robot.png" alt="bacteria.png" class="img-responsive center-block wow  bounceIn"> -->
						<h4>تطوير تطبيقات المحمول مخصصه للجامعات والكليات والمدارس</h4>
						<p>
							نعمل على تطوير حل متكامل لتطبيقات الجوّال لجميع المدارس والكليات والجامعات التي تساعد الوالدين والطلاب على التواصل مع المعلمين والحصول على إمكانية الوصول الفوري إلى الأحداث والأخبار وإشعارات التقييم والتحديثات الرياضية والنشرة الإخبارية ومعلومات السفر المدرسي والمزيد.
						</p>
						</div></a>
					</div>
				</div>
...
<button class="btn btn-primary  btn-lang" type="button" data-toggle="collapse" data-target="#solutions" aria-expanded="false" aria-controls="collapseExample">
شاهد المزيد
</button>
			</div>
		</div>
